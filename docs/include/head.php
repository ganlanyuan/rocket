...
<head>
  ...
  <title> <?php 
		...
		if ($pagename == 'addons-button') {
			echo 'addons-button';
		} 
		if ($pagename == 'addons-media-list') {
			echo 'addons-media-list';
		} 
		if ($pagename == 'addons-off-canvas') {
			echo 'addons-off-canvas';
		} 
		if ($pagename == 'addons-dropdown') {
			echo 'addons-dropdown';
		} 
		if ($pagename == 'addons-tooltip') {
			echo 'addons-tooltip';
		} 
		if ($pagename == 'addons-visibility') {
			echo 'addons-visibility';
		} 
		if ($pagename == 'addons-flex-video') {
			echo 'addons-flex-video';
		} 
  ...
  <link <?php 
		...
		if ($pagename == 'addons-button') {
			echo 'href="css/addons-button.css"';
		} 
		if ($pagename == 'addons-media-list') {
			echo 'href="css/addons-media-list.css"';
		} 
		if ($pagename == 'addons-off-canvas') {
			echo 'href="css/addons-off-canvas.css"';
		} 
		if ($pagename == 'addons-dropdown') {
			echo 'href="css/addons-dropdown.css"';
		} 
		if ($pagename == 'addons-tooltip') {
			echo 'href="css/addons-tooltip.css"';
		} 
		if ($pagename == 'addons-visibility') {
			echo 'href="css/addons-visibility.css"';
		} 
		if ($pagename == 'addons-flex-video') {
			echo 'href="css/addons-flex-video.css"';
		} 
		if ($pagename == 'color-contrast') {
