<div>
  ...
  <ul class="glyphs css-mapping">
    ...
    <li>
      <div class="icon ic-comments"></div>
    ...
    <li>
      <div class="icon ic-chat-empty"></div>
      <input type="text" readonly="readonly" value="chat-empty">
    </li>
    <li>
      <div class="icon ic-chat-two"></div>
      <input type="text" readonly="readonly" value="chat-two">
    </li>
    <li>
    ...
    <li>
      <div class="icon ic-email-empty"></div>
      <input type="text" readonly="readonly" value="email-empty">
    </li>
    <li>
    ...
    <li>
      <div class="icon ic-star-empty"></div>
    ...
    <li>
      <div class="icon ic-share-empty"></div>
      <input type="text" readonly="readonly" value="share-empty">
    </li>
    <li>
    ...
    <li>
      <div class="icon ic-rss-square"></div>
    ...
    <li>
      <div class="icon ic-google-plus-square"></div>
    ...
    <li>
      <div class="icon ic-call-square"></div>
      <input type="text" readonly="readonly" value="call-square">
    </li>
    <li>
    ...
    <li>
      <div class="icon ic-search-android"></div>
      <input type="text" readonly="readonly" value="search-android">
    </li>
    <li>
    ...
    <li>
      <div class="icon ic-pinterest-circle"></div>
      <input type="text" readonly="readonly" value="pinterest-circle">
    </li>
    <li>
    ...
    <li>
      <div class="icon ic-github"></div>
      <input type="text" readonly="readonly" value="github">
    </li>
    <li>
      <div class="icon ic-github-cricle"></div>
      <input type="text" readonly="readonly" value="github-cricle">
    </li>
  </ul>
