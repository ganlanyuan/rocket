<div class="more-demos">
  ...
  <nav class="demo-links">
    ...
    <a <?php if ($pagename == 'layout-debug' ) { echo 'class="current"'; } ?> href="layout-debug.php">debug</a>
  </nav>
  <h4>slider</h4>
  <nav class="demo-links">
    <a <?php if ($pagename == 'slider-carousel' ) { echo 'class="current"'; } ?> href="slider-carousel.php">carousel</a>
    <a <?php if ($pagename == 'slider-gallery' ) { echo 'class="current"'; } ?> href="slider-gallery.php">gallery</a>
  </nav>
  <h4>addons</h4>
  <nav class="demo-links">
