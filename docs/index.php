  ...
  <div class="intro">
    <div class="container">
      <div class="intro-content">
        ...
        <div>
          <a href="https://github.com/ganlanyuan/rocket/archive/master.zip" target="_blank" class="button active">Download (0.0.1)</a><a href="https://github.com/ganlanyuan/rocket" target="_blank" class="button">View on Github</a>
        </div>
      </div>
    </div>
  </div>
