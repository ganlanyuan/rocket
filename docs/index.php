  ...
  <div class="intro">
    <div class="container">
      <div class="intro-content">
        ...
        <div>
          <a href="https://github.com/ganlanyuan/codeset/archive/master.zip" target="_blank" class="button active">Download</a><a href="https://github.com/ganlanyuan/codeset" target="_blank" class="button">View on Github</a>
        </div>
      </div>
    </div>
  </div>
