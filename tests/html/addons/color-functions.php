...
<div class="page">
  <div class="container">
    ...
    <div class="topic">
      ...
      <h4>Contrast</h4>
      <div class="contrast clearfix three">
      ...
      <div class="example-adjacent clearfix three">
      ...
      <div class="example-complementary clearfix two">
        <div class="color-box color-box-original">original</div>
      ...
      <div class="example-split-complementary clearfix three">
        <div class="color-box color-box-original">original</div>
      ...
      <div class="example-triad clearfix three">
        <div class="color-box color-box-original">original</div>
      ...
      <div class="example-rectangle clearfix four">
        <div class="color-box color-box-original">original</div>
      ...
      <div class="example-square clearfix four">
        <div class="color-box color-box-original">original</div>
