...
<p>
  ...
  <img src="https://img.shields.io/badge/Version-2.5.5-blue.svg">
</p>
Rocket is a powerful SASS library to help web developers handle layout, color and other components.    

**Version 2 will not be updated except issue fixing. If you want to keep updated, please turn to [master](https://github.com/ganlanyuan/rocket/).**   
