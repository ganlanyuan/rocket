<div class="more-demos">
  ...
  <nav class="demo-links">
    <?php 
      $layouts = array('grid', 'gallery', 'justify', 'center', 'liquid-2', 'liquid-3');
      $cur = '';
  ...
  <nav class="demo-links">
    <?php 
      $components = array('button', 'media-list', 'offcanvas', 'mobile-nav', 'dropdown', 'tabs', 'switch', 'accordion', 'push-toggle', 'checkbox', 'tooltip', 'flex-video', 'validation', 'slider-carousel', 'slider-gallery'); 
      $cur = '';
